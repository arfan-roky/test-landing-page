    ...
    <div className="w-full  md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-3xl">
          Follow these simple steps to create, customize, and launch your very
          own e-commerce website. From logging in to selecting the perfect
          package and going live, we’ve made it easy for you to start selling
          online in no time.
        </p>
      </div>
